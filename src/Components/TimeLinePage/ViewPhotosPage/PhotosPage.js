    ...
    return (
        <div className={classes.flex}>
            <div className={classes.photo}>
                {photos && <div className={classes.flex}>
                    {currentPhoto > 1 && <div className={`${classes.arrow} ${classes.back}`} onClick={() => {setCurrentPhoto(prevNum => prevNum - 1);}}><ArrowBackOutlinedIcon/></div>}
                    <img className={classes.image} src={photos[currentPhoto - 1]} alt=""/>
                    {currentPhoto < photos.length && <div className={`${classes.arrow} ${classes.forward}`} onClick={() => {setCurrentPhoto(prevNum => prevNum + 1);}}><ArrowForwardOutlinedIcon/></div>}
                </div>}
                {photosTweet && <div id="FeedTweetAttributes" className={classes.attributes}>
                    <TweetAtrribute
